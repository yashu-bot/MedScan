...
export default function PatientAIDashboardPage() {
  return (
    <div className="container mx-auto py-8">
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-3xl"><Bot className="h-8 w-8 text-primary"/>MedScan AI</CardTitle>
          <CardDescription className="text-md">
            AI assistance for patients. Results are informational and not medical advice.
          </CardDescription>
        </CardHeader>
        <CardContent>
